...
###########################################################
foodweb(c( find.funs(),find.funs("package:FME"),'solnp',find.funs("package:mkin")),where=1, prune = "IRLSkinfit.full",border = TRUE,expand.xbox = 2, boxcolor = "#FC6512",textcolor = "black", cex = 1.0, lwd=2)
