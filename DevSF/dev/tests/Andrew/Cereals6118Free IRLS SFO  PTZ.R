# Trial           : Cereals6118Free
# File name       : Cereals6118Free IRLS SFO  PTZ.r
...
#
 ...
 list2ascii(
            ...
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118Free IRLS SFO  PTZ.kgo')

   kingraph(Fit,
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118Free IRLS SFO  PTZ.kgg')
