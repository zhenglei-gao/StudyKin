# Trial           : Cereals6118FreeDFOP
# File name       : Cereals6118FreeDFOP IRLS DFOP PTZ.r
...
#
 ...
 Cereals6118FreeDFOP <- mkinmod.full(
        PTZ = list(
...
#
 ...
 list2ascii(
            ...
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118FreeDFOP IRLS DFOP PTZ.kgo')

   kingraph(Fit,
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118FreeDFOP IRLS DFOP PTZ.kgg')
