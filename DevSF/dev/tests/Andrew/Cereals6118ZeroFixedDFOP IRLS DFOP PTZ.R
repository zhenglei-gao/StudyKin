# Trial           : Cereals6118ZeroFixedDFOP
# File name       : Cereals6118ZeroFixedDFOP IRLS DFOP PTZ.r
...
#
 ...
 list2ascii(
            ...
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFixedDFOP IRLS DFOP PTZ.kgo')

   kingraph(Fit,
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFixedDFOP IRLS DFOP PTZ.kgg')
