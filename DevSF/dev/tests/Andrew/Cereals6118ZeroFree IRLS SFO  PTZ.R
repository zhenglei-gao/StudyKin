# Trial           : Cereals6118ZeroFree
# File name       : Cereals6118ZeroFree IRLS SFO  PTZ.r
...
#
 ...
 Cereals6118ZeroFree <- mkinmod.full(
        PTZ = list(
...
#
 ...
 list2ascii(
            ...
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFree IRLS SFO  PTZ.kgo')

   kingraph(Fit,
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFree IRLS SFO  PTZ.kgg')
