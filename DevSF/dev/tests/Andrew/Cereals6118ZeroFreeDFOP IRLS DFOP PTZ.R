# Trial           : Cereals6118ZeroFreeDFOP
# File name       : Cereals6118ZeroFreeDFOP IRLS DFOP PTZ.r
...
#
 ...
 Cereals6118ZeroFreeDFOP <- mkinmod.full(
        PTZ = list(
...
#
 ...
 list2ascii(
            ...
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFreeDFOP IRLS DFOP PTZ.kgo')

   kingraph(Fit,
            'C:/Emod/KinGUII/WorkingDirectory/Voles/Cereals/Cereals6118ZeroFreeDFOP IRLS DFOP PTZ.kgg')
