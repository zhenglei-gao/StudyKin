...
KinEval <- function(mkinmodini,
                    ...
                    optimMethod=c("Marq", "Port", "Newton", "Nelder-Mead", "BFGS", 
                    ...
                    update=NULL,useHsolnp=FALSE,...)
{
  ...
  ## o1 <- KinEval(a,evalMethod='IRLS',optimMethod='Marq')
  ## summary(o1)
  ## b <- mkinmod.full(
  ##   parent = list(type = "SFO", to = c("A1", "B1", "C1"), sink = FALSE),
  ##   A1 = list(type = "SFO", to = "A2"),
  ...
  ## o2 <- KinEval(b,evalMethod='NLS',optimMethod='Marq')
  ## summary(o2)
  ...
  # ----------------------------------------
  ## Set or Update the initial parameters.
